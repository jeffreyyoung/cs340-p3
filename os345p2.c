...
int P2_project2(int argc, char* argv[])
{
	...
	static char* tensecArgv[] = {"tenseconds"};
	...
	createTask("tenseconds1",
				P2_tensec,
				HIGH_PRIORITY,
				1,
				tensecArgv);
	createTask("tenseconds2",
				P2_tensec,
				HIGH_PRIORITY,
				1,
				tensecArgv);
	createTask("tenseconds3",
				P2_tensec,
				HIGH_PRIORITY,
				1,
				tensecArgv);
	createTask("tenseconds4",
				P2_tensec,
				HIGH_PRIORITY,
				1,
				tensecArgv);
	createTask("tenseconds5",
				P2_tensec,
				HIGH_PRIORITY,
				1,
				tensecArgv);
	createTask("tenseconds6",
				P2_tensec,
				HIGH_PRIORITY,
				1,
				tensecArgv);
	createTask("tenseconds7",
				P2_tensec,
				HIGH_PRIORITY,
				1,
				tensecArgv);
	createTask("tenseconds8",
				P2_tensec,
				HIGH_PRIORITY,
				1,
				tensecArgv);
	createTask("tenseconds9",
				P2_tensec,
				HIGH_PRIORITY,
				1,
				tensecArgv);
...
int P2_tensec(int argc, char* argv[]){
	while(1){
		SEM_WAIT(tics10sec);
		printf("\nHello from %s (task %d)!\n", tcb[curTask].name, curTask);
		swapTask();
	}
	return 0;
}
